        ...
        private fun matchTypes(
            ...
            if (type1 != null && type2 != null) {
                ...
                if (!args1.withIndex().all { p ->
                    ...
                    val typeArgRef1 = typeRef1?.typeElement?.typeArgumentsAsTypes?.getOrNull(i)
                    val typeArgRef2 = typeRef2?.typeElement?.typeArgumentsAsTypes?.getOrNull(i)

                    if (arg1.projectionKind != arg2.projectionKind) return@all false
