...
import org.jetbrains.kotlin.idea.refactoring.introduce.introduceTypeAlias.IntroduceUtilKt;
...
public class KotlinIntroduceTypeAliasDialog extends DialogWrapper {
    ...
    private boolean isVisibilitySectionAvailable() {
        return IntroduceUtilKt.isVisibilityApplicable(originalDescriptor.getOriginalData());
    }
    ...
    private void update() {
        ...
        signaturePreviewField.setText(IntroduceUtilKt.generateTypeAlias(currentDescriptor, true).getText());
    }
    ...
    protected void doOKAction() {
        MultiMap<PsiElement, String> conflicts = IntroduceUtilKt.validate(currentDescriptor).getConflicts();
    ...
    private IntroduceTypeAliasDescriptor createDescriptor() {
        return originalDescriptor.copy(
                ...
                getAliasName(),
                getVisibility(),
                parameterTablePanel.getSelectedTypeParameters()
        );
    }
