...
@get:TestOnly
@set:TestOnly
internal var Project.introduceTypeAliasDescriptorSubstitutor : ((IntroduceTypeAliasDescriptor) -> IntroduceTypeAliasDescriptor)?
        by UserDataProperty(Key.create("INTRODUCE_TYPE_ALIAS_DESCRIPTOR_SUBSTITUTOR"))
...
object KotlinIntroduceTypeAliasHandler : RefactoringActionHandler {
    ...
    fun doInvoke(project: Project, editor: Editor, elements: List<PsiElement>, targetSibling: PsiElement) {
        ...
        when (analysisResult) {
            ...
            is IntroduceTypeAliasAnalysisResult.Success -> {
                ...
                if (ApplicationManager.getApplication().isUnitTestMode) {
                    val (descriptor, conflicts) = project.introduceTypeAliasDescriptorSubstitutor!!(originalDescriptor).validate()
