...
import org.jetbrains.kotlin.idea.refactoring.introduce.introduceTypeAlias.introduceTypeAliasDescriptorSubstitutor
...
abstract class AbstractExtractionTest() : KotlinLightCodeInsightFixtureTestCase() {
    ...
    protected fun doIntroduceTypeAliasTest(path: String) {
        doTest(path) { file ->
            ...
            val helper = fun (descriptor: IntroduceTypeAliasDescriptor): IntroduceTypeAliasDescriptor {
                return descriptor.copy(name = aliasName, visibility = aliasVisibility ?: descriptor.visibility)
            }
            project.introduceTypeAliasDescriptorSubstitutor = helper
            val editor = fixture.editor
